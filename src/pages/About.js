...
const About = () => {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }} className="font-quicksand container mx-auto px-4 pt-24 flex flex-col items-center md:flex-row">
        ...
        <div className="flex flex-col gap-y-11 md:flex-row md:justify-between mb-16 bg-white p-8 rounded-lg shadow-lg">
          ...
          <div className="md:w-1/2">
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              <a href='https://www.adobe.com/id_en/products/photoshop.html' className="bg-slate-700 bg-opacity-25 px-3 md:px-6  py-3 rounded-full md:text-lg">Adobe Photoshop</a>
              <a href='https://filmora.wondershare.com/' className="bg-slate-700 bg-opacity-25 px-3 md:px-6  py-3 rounded-full md:text-lg">Filmora</a>
              <a href='https://www.canva.com/' className="bg-slate-700 bg-opacity-25 px-3 md:px-6  py-3 rounded-full md:text-lg">Canva</a>
              <a href='https://react.dev/' className="bg-slate-700 bg-opacity-25 px-3 md:px-6 py-3 rounded-full md:text-lg">React JS</a>
              <a href='https://tailwindcss.com/' className="bg-slate-700 bg-opacity-25 px-3 md:px-6  py-3 rounded-full md:text-lg">TailwindCSS</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="md:w-1/3 pl-8 flex flex-col md:order-2">
        ...
        {/* Name, Location, Email, and Phone */}
          <div className="w-[95%] flex flex-col items-center bg-white p-4 rounded-lg mb-16 shadow-lg">
            <span className='text-4xl font-quicksand font-light'>Jazz O'Gibran</span>
            <motion.div 
            whileHover={{ scale: 1.05 }}
          style={{ transition: 'transform 0.3s ease' }} className='w-max'
          >
              <Link to="/contact">
              <u>See my contacts here!   </u>
            </Link>
            </motion.div> 
          </div>
